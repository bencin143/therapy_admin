$( document ).ready(function() {
  $("#oracle_connection").click(function(){
...
//alert("Hello World!");
var dataString = 'ort='+ org + '&ipaddt='+ add + '&portaddt='+ por + '&datusrt='+ user + '&datpassst='+ pass + '&sernamee='+ serv + '&boxess[]='+ values;
//alert(dataString);
if(org==''||add==''||por==''||user==''||pass==''||serv=='')
{
