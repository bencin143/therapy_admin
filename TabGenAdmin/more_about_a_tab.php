							...
							"<div style='float:right' class='dropdown'>"+
							  ...
							  "<ul class='dropdown-menu dropdown-menu-right'>"+
								...
								"<li role='separator' class='divider'></li>"+
                                                                ...
                                                                "<li><a class='tools' onclick='deleteFile(\""+i+"\");'>Delete</a></li>"+
                                                                "<li><a class='tools' data-toggle='modal' data-target='#share_news' onclick='share(\""+i+"\");'>Share to other Tabs</a></li>"+
							  "</ul>"+
							"</div><br/>";
						if(i%2==0){
							article_left+=""+
...
<!--    modal for sharing news to other tabs-->
					...
					<div class="panel panel-default clearfix">
						<form class="form-horizontal" id="publish_a_news">
							<div class="panel-body">							
								<div class="form-group">
									<label class="col-sm-2  control-label" for="news_title">Article Title:</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									<label class="col-sm-2  control-label" for="news_headline">Article Headline:</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									<label class="col-sm-2  control-label" for="news_details">Article Details:</label>
									<div class="col-sm-10">
...
//											}
	...
	<div class="modal fade" id="share_news" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-lg" style='width:78%;' role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove"></span></button>
					<h4 class="modal-title" id="myModalLabel">Share News</h4>
				</div>
				<div class="modal-body">	
					<div class="panel panel-default clearfix">
	...
	<?php $res=listTabs($conn,$_GET['tab_id']);   
      
            while($row = $res->fetch(PDO::FETCH_ASSOC)){
                
                echo "<input type='checkbox' name='chk1[]' value='".$row['Id']."'>    ".$row['Name']."";
       ...
       ?>
								...
								<div class="panel-footer clearfix">
									<div id="publishNewsResponse"></div>
									<div class="pull-right">
										<button type="button" class="btn btn-info" id="clicko"
											onclick="share(\""+i+"\");">share</button>
