...
if($conn){
	...
	$query = "insert into HISConnectivit1y(Id,CreateAt,UpdateAt,DeleteAt,OrganisationName,DataServerIPAdd,DataBasePortAddress,DatabaseUsername,DatabasePassword,Queries)
