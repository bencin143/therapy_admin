...
public class News_ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public News_ExpandableListAdapter(Context context, List<String> expandableListTitle,
